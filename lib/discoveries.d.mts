export type Discovery = { id:string; title:string; category:string; url:string; source:string; discoveredAt:string; lastSeenAt?:string; city?:string; start?:string; end?:string; location?:string; price?:string; sourceUrl?:string };
